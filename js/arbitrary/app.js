...
var ArbitraryCurveGraph = (function (_super) {
    __extends(ArbitraryCurveGraph, _super);
    function ArbitraryCurveGraph() {
        _super.apply(this, arguments);
    }
    ArbitraryCurveGraph.prototype.bernstein = function (n, i, t) {
        var binom = 1;
    ...
    ArbitraryCurveGraph.prototype.vectorAtT = function (vertices, t) {
    ...
    ArbitraryCurveGraph.prototype.arbitraryBezier = function (vertices, nb) {
        var bez = [];
        var step = 1 / nb;
        for (var i = 0; i <= 1; i += step) {
    ...
    ArbitraryCurveGraph.prototype.initCurves = function () {
        if (this.points.length < 2) {
            return;
        }
        var curvePoints = this.arbitraryBezier(this.points, 50);
        this.curves[0] = BABYLON.Mesh.CreateLines("name", curvePoints, this.scene, true);
    };
    ArbitraryCurveGraph.prototype.updateSpline = function (pointIndex) {
        if (this.points.length < 2) {
            return;
        }
        var curvePoints = this.arbitraryBezier(this.points, 50);
    ...
    return ArbitraryCurveGraph;
}(BaseCurveGraph));
var LongArbitraryCurvePlance = (function (_super) {
    __extends(LongArbitraryCurvePlance, _super);
    function LongArbitraryCurvePlance(name, width, height, scene, graph) {
        _super.call(this, name, 1300, 600, scene, graph);
        this.graph = new ArbitraryCurveGraph("arbitrary", [], scene, 0);
    }
    return LongArbitraryCurvePlance;
}(SimpleCurvePlane));
var ArbitraryCurveEditor = (function () {
    function ArbitraryCurveEditor(name, scene) {
        this.scene = scene;
        this.name = name;
        this.curvePlane = new LongArbitraryCurvePlance("plane", 0, 0, scene);
    }
    ArbitraryCurveEditor.prototype.onPointerDown = function (evt, pickingInfo) {
        this.curvePlane.onPointerDown(evt, pickingInfo);
    };
    ArbitraryCurveEditor.prototype.onPointerUp = function (evt, pickingInfo) {
        this.curvePlane.onPointerUp(evt, pickingInfo);
    };
    ArbitraryCurveEditor.prototype.onPointerMove = function (evt, pickingInfo) {
        this.curvePlane.onPointerMove(evt, pickingInfo);
    };
    ArbitraryCurveEditor.prototype.saveJsonData = function () {
        return this.curvePlane.saveJsonData();
    };
    ArbitraryCurveEditor.prototype.loadJsonData = function (json) {
        this.curvePlane.loadJsonData(json);
    };
    ArbitraryCurveEditor.prototype.loadVectorData = function (vectorData) {
        this.curvePlane.loadVectorData(vectorData);
    };
    return ArbitraryCurveEditor;
}());
...
var createScene = function () {
    ...
    editor = new ArbitraryCurveEditor("editor", scene);
